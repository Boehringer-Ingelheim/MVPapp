...
if(debug_mode) {
  ...
  source("ui_settings_v_0_2_13.R")       # List of UI settings e.g. labels and descriptions
  source("code_templates_v_0_2_10.R")    # List of example mrgsolve models
  source("functions_v_0_2_13.R")         # List of helper functions required for the app
